...
storyline = {
    ...
    "scene2": {
        ...
        "step6": {
            "description": "会話が途中で中断され、先生が夏休みの宿題の提出を促してきた。宿題が多く、提出するのにも時間がかかった。あいがため息をつきながら言った:「疲れたー。usernameさん、夏休みの宿題、どうやって終わらせました？私は計画を立てて、毎日ちょっとずつ取り組んでいました。」",
            "answer": True,
            "GPT_character": "鈴木あい",
    ...
    "scene4": {
        ...
        "step4": {
        "description":"メニューは以下となります：好きな一品をお選びください。",
        "timecount":True,
        "button":True,
        "image":True,
        ...
        "imageclass":{
        "1.特製ハンバーグステーキ - 自家製ソースで仕上げたジューシーなハンバーグ。付け合わせには、季節の野菜とマッシュポテトが添えられています。":"hamburgersteak",
        "2.鶏のクリーム煮 - 柔らかく煮込んだ鶏肉を、濃厚なクリームソースで味わう一品。バゲットが付いてきます。":"creamchicken",
        "3.海鮮パエリア - 新鮮な海の幸がふんだんに使われた、彩り豊かなスペイン料理。サフランの香りが食欲をそそります。":"seafood",
        "4.	野菜たっぷりグリーンカレー - 辛さ控えめのココナッツベースのカレー。たくさんの種類の野菜が入っていて、ヘルシーです。":"curry",
        "5.マルゲリータピザ - シンプルながらも、トマトの酸味とモッツァレラチーズの濃厚さが絶妙なバランスのピザ。":"pizza"
        },
        "next": {"step5"}
        },
